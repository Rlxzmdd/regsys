...
values ('计算机科学与技术2021班', 'TCH001', 'COUN001', 'ASSIST001', 1, 1, 1, 1),
...
insert into user_student (real_name, stu_number, phone, id_card, gender, nation, email, qq, politic, serial_number,
                          exam_number, stu_status, college_id, major_id, classes_id, avatar, create_user, update_user)
values ('张三', 'S2021001', '13812345678', '320123456789012345', '男', '汉族', 'zhangsan@example.com', '123456',
        '共青团员', '2021001', '2021001', '在校', 1, 1, 1, 'avatar1.jpg', 1, 1),
       ('李四', 'S2021002', '13912345678', '320123456789012346', '女', '汉族', 'lisi@example.com', '234567', '党员',
        '2021002', '2021002', '在校', 2, 2, 2, 'avatar2.jpg', 2, 2),
       ('王五', 'S2021003', '13612345678', '320123456789012347', '男', '汉族', 'wangwu@example.com', '345678', '团员',
        '2021003', '2021001', '在校', 1, 1, 1, 'avatar3.jpg', 1, 1),
       ('赵六', 'S2021004', '13512345678', '320123456789012348', '女', '汉族', 'zhaoliu@example.com', '456789', '群众',
        '2021004', '2021002', '在校', 2, 2, 2, 'avatar4.jpg', 2, 2),
       ('钱七', 'S2021005', '13712345678', '320123456789012349', '男', '汉族', 'qianqi@example.com', '567890', '党员',
        '2021005', '2021001', '在校', 1, 1, 1, 'avatar5.jpg', 1, 1),
       ('张八', 'S2021006', '13812345679', '320123456789012350', '男', '汉族', 'zhangba@example.com', '678901',
        '共青团员', '2021006', '2021001', '在校', 1, 1, 2, 'avatar6.jpg', 1, 1),
       ('李九', 'S2021007', '13912345679', '320123456789012351', '女', '汉族', 'lijiu@example.com', '789012', '党员',
        '2021007', '2021002', '在校', 2, 2, 2, 'avatar7.jpg', 2, 2),
       ('王十', 'S2021008', '13612345679', '320123456789012352', '男', '汉族', 'wangshi@example.com', '890123', '团员',
        '2021008', '2021001', '在校', 1, 1, 3, 'avatar8.jpg', 1, 1),
       ('赵十一', 'S2021009', '13512345679', '320123456789012353', '女', '汉族', 'zhaoyiyi@example.com', '901234',
        '群众', '2021009', '2021002', '在校', 2, 2, 3, 'avatar9.jpg', 2, 2),
       ('钱十二', 'S2021010', '13712345679', '320123456789012354', '男', '汉族', 'qianerbai@example.com', '012345',
        '党员', '2021010', '2021001', '在校', 1, 1, 4, 'avatar10.jpg', 1, 1),
       ('孙十三', 'S2021011', '13812345680', '320123456789012355', '女', '汉族', 'sunsansan@example.com', '123456',
        '共青团员', '2021011', '2021002', '在校', 2, 2, 4, 'avatar11.jpg', 2, 2),
       ('周十四', 'S2021012', '13912345680', '320123456789012356', '男', '汉族', 'zhou1414@example.com', '234567',
        '党员', '2021012', '2021001', '在校', 1, 1, 5, 'avatar12.jpg', 1, 1),
       ('吴十五', 'S2021013', '13612345680', '320123456789012357', '女', '汉族', 'wuwuwu@example.com', '345678', '团员',
        '2021013', '2021002', '在校', 2, 2, 5, 'avatar13.jpg', 2, 2),
       ('郑十六', 'S2021014', '13512345680', '320123456789012358', '男', '汉族', 'zhengzheng@example.com', '456789',
        '群众', '2021014', '2021001', '在校', 1, 1, 6, 'avatar14.jpg', 1, 1),
       ('陈十七', 'S2021015', '13712345680', '320123456789012359', '女', '汉族', 'chenshishi@example.com', '567890',
        '党员', '2021015', '2021002', '在校', 2, 2, 6, 'avatar15.jpg', 2, 2);
...
insert into user_teacher (real_name, tch_number, gender, phone, email, qq, office, password, identity, college_id,
                          department_id, create_user, update_user)
values ('张老师', 'TCH001', '男', '13898765432', 'zhangteacher@example.com', '123456', '教师办公室A', 'password1',
        '普通教师', 1, 1, 1, 1),
       ('李老师', 'TCH002', '女', '13998765432', 'liteacher@example.com', '234567', '教师办公室B', 'password2',
        '普通教师', 2, 2, 2, 2),
       ('王老师', 'TCH003', '男', '13698765432', 'wangteacher@example.com', '345678', '教师办公室C', 'password3',
        '普通教师', 3, 3, 3, 3),
       ('赵老师', 'TCH004', '女', '13598765432', 'zhaoteacher@example.com', '456789', '教师办公室D', 'password4',
        '普通教师', 4, 4, 4, 4),
       ('钱老师', 'TCH005', '男', '13798765432', 'qianteacher@example.com', '567890', '教师办公室E', 'password5',
        '普通教师', 5, 5, 5, 5);
...
(
    id          bigint unsigned auto_increment comment '记录ID'
        primary key,
    type        enum ('STU_NUMBER', 'EXAM_NUMBER', 'TCH_NUMBER')                       not null comment '信息类型',
    username    varchar(30)                                                            not null comment '用户名',
    password    varchar(50)                                                            not null comment '密码',
    bind_type   tinyint(1)                                                             not null comment '绑定类型: 0学生 1教师',
    bind_number varchar(30)                                                            not null comment '绑定工号',
    create_user int unsigned                                                           null comment '创建记录用户',
    update_user int unsigned                                                           null comment '更新记录用户',
    create_time datetime         default CURRENT_TIMESTAMP                             null comment '创建时间',
    ...
    comment '用户账号信息表';
insert into user_account (type, username, password, bind_type, bind_number, create_user, update_user)
values ('STU_NUMBER', 'stu_zhang', 'pwd123', 0, 'S2021001', 1, 1),
       ('EXAM_NUMBER', 'exam_li', 'pwd456', 0, '2021002', 2, 2),
       ('TCH_NUMBER', 'tch_wang', 'pwd789', 1, 'TCH003', 3, 3),
       ('STU_NUMBER', 'stu_zhao', 'pwd101', 0, 'S2021004', 4, 4),
       ('EXAM_NUMBER', 'exam_qian', 'pwd102', 0, '2021005', 5, 5);
